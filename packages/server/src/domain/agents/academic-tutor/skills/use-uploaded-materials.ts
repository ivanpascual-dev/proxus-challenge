...
export const UseUploadedMaterialsSkill = AgentSkill.make({
  ...
  description: "Use uploaded PDF materials: read their indexed text, or render page ranges as images, before answering material-specific questions.",
  content: [
    "# Use uploaded materials",
    "",
    "Use this skill when the user asks about uploaded PDFs, slides, readings, or specific pages.",
    "(For the study note, a block, or the mind map of a material, use the use-study-notes skill",
    "instead: that is a different question.)",
    "",
